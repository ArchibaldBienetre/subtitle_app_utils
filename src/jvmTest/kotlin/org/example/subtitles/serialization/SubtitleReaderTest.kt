...
class SubtitleReaderTest {
    ...
    fun readTestSubtitlesSingleEntry() {
        ...
        val entriesStream = ByteArrayOutputStream()
        entriesStream.writeBytes(converter.toString(entry).toByteArray())
